...
class DiaryTest {
    ...
    public void findEntryByDateTest(){
        Diary myDiary = new Diary("nutmeg", "@2345");
        myDiary.createEntry("kamasutra", "5, May, 2022", "reaching climax");
        myDiary.createEntry("Java", "6, May, 2022", "reaching climax");
        myDiary.createEntry("Python", "7, May, 2022", "reaching climax");
        myDiary.createEntry("Database", "8, May, 2022", "reaching climax");
        myDiary.createEntry("Industrial design", "9, May, 2022", "reaching climax");
        assertEquals(5, myDiary.getNumberOfEntry());
    ...
    public void lockAndUnlockTest(){
        ...
        int when = myDiary.findEntryByDate("4, May, 2022");
        assertEquals(-8, when);
        assertEquals(false, myDiary.unlockDiary("@2365"));
